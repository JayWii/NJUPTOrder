...
- (void)viewDidLoad {
   ...
   NSString *name = [NSString stringWithFormat:@"roller0%d.png", i + 1];
   ...
   //        隐藏指示
    ...
    self.CostView.layer.masksToBounds = YES;
    self.CostView.layer.cornerRadius=8;
    ...
    [segmentedControl1 setBackgroundColor:[UIColor colorWithRed:48.0f/255.0f green:39.0f/255.0f blue:34.0f/255.0f alpha:1.0f]];

    [segmentedControl1 setTextColor:[UIColor whiteColor]];

    [segmentedControl1 setSelectionIndicatorColor:[UIColor colorWithRed:170.0f/255.0f green:11.0f/255.0f blue:14.0f/255.0f alpha:1.0f]];
    [segmentedControl1 setSelectionStyle:HMSegmentedControlSelectionStyleBox];

    segmentedControl1.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleWidth;
    [segmentedControl1 setFrame:CGRectMake(332, 223, width-352, 57)];
    ...
    [self.DeskNumBtn setTitle:[ud objectForKey:@"desknumber"] forState:UIControlStateNormal];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (rowData!=nil) {
       ...
       cell.NameLabel.text=[NSString stringWithFormat:@"%ld %@(%@)",(long)num,rowData[@"name"], rowData[@"ladu"]];
...
//点击订单按钮时，会执行此方法，会跳转到OrderTableViewCell
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    if ([alertType isEqualToString:@"del"]) {
        ...
        if (buttonIndex==1) {
            ...
            self.SumTitleLabel.frame=CGRectMake(176, 312, 55, 21);
