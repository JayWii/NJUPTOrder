...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (rowData!=nil) {
        ...
        cell.NameLabel.text=[NSString stringWithFormat:@"%d %@(%@)",num,rowData[@"name"],rowData[@"ladu"]];
...
- (IBAction)checkout:(id)sender {
    ...
    UIViewController *vc= [storyBoard instantiateViewControllerWithIdentifier:@"QRCodeview"];
